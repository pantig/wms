...
internal sealed record SimulationSnapshotDto(
    ...
    bool IsBlocked,
    string? BlockMessage,
    bool IsLoadWaitingForUnload,
    bool IsFinalBlocked,
    string TotalLoadBlockTime,
    double TotalLoadBlockSeconds,
    string CurrentLoadBlockTime,
    double CurrentLoadBlockSeconds,
    string? PendingLoadPallet,
    string CurrentTime,
